...
I set up a local VM on a local Kubernetes Master using VMWare Fusion as my Ansible Controller. I downloaded the Google Cloud prerequisits. I developed my solution using Atom with the Yaml line and remote plugins
